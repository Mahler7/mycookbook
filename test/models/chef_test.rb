...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "test", email: "test@gmail.com", password: "password", password_confirmation: "password")
  end
  ...
  test "should reject invalid emails" do
    invalid_emails = %w[user@example test@gmail,com test.name@gmail joe@bar+foo.com]
  ...
  test "associated recipes should be destroyed" do
    @chef.save
    @chef.recipes.create!(name: "testing destroy", description: "testing destroy funciton")
